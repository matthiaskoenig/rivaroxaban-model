...
class Ding2020(RivaroxabanSimulationExperiment):
    ...
    colors = {
        "Fasting_R10": "#B97ACC",  # medium purple
        "Fasting_T10": "#DDB8EA",  # light lavender
        "Fed_R10": "#7132A8",  # deep violet
        "Fed_T10": "#A35AC7",  # rich purple
    }
    formulation_labels = {
        "T10": "Test 10 mg",
        "R10": "Reference 10 mg",
    ...
    def figures(self) -> Dict[str, Figure]:
        fig = Figure(
            experiment=self,
            sid="Fig1_2",
            name=f"{self.__class__.__name__} (healthy), 10 mg po"
        )
...
if __name__ == "__main__":
    out = rivaroxaban.RESULTS_PATH_SIMULATION / Ding2020.__name__
